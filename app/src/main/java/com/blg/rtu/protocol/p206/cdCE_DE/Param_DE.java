...
public class Param_DE implements Serializable{
	
	private static final long serialVersionUID = 201409240057001L;

	public static final String KEY = Param_DE.class.getName() ;
	...
	public String toString(){
		String s = "\n" ;
		s += "短信中心：" + "\n" +
		" 短信中心1：" + (enable_1.intValue() == 1?"有效":"无效") + " 号码：" + sate1 + "\n" +
		" 短信中心2：" + (enable_2.intValue() == 1?"有效":"无效") + " 号码：" + sate2 + "\n" +
		" 短信中心3：" + (enable_3.intValue() == 1?"有效":"无效") + " 号码：" + sate3 + "\n" +
		" 短信中心4：" + (enable_4.intValue() == 1?"有效":"无效") + " 号码：" + sate4 + "\n" ;
		return s ;
	}
