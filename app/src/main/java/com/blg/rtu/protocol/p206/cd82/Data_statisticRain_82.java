...
public class Data_statisticRain_82 extends Data_rain{
	...
	public String toString(){
		String s = "\n时段类型 : " + (this.stageType==null?"":stageType.intValue() == stageType_5m?"5分钟时段降雨量":(stageType.intValue() == stageType_1h?"小时段降雨量":(stageType.intValue() == stageType_1d?"日时段降雨量":(stageType.intValue() == stageType_t?"测试累计降雨量":(""))))) + "\n" ;
		return s ;
	}
